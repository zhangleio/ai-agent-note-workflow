...
- [README.md](README.md) 是工作流语义、生命周期和文档格式的主要说明；本文件将其中要求转换为执行约束。
...
- 根 [README.md](README.md) 说明可复用工作流；[examples/README.md](examples/README.md) 维护示例项目索引。
- 行为变化必须同步更新受影响的 README、命令示例和 Agent Note。
- 文档描述当前可验证事实，不把 proposed Note 当作已经实现的行为。
- 文件路径和命令应可从其文档声明的工作目录直接使用。
